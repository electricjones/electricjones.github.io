...
As I said, I will explore this potential exchange format (with current examples) later, but I wanted to keep that in mind while designing the internal data model for Kadoo.
{: .article_paragraph }
